...
export default function App() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-background flex">
      {currentView !== 'landing' && <Sidebar currentView={currentView} setView={setCurrentView} />}
      
      <div 
        ref={scrollContainerRef}
        className={`w-full h-full relative overflow-y-auto overflow-x-hidden ${currentView !== 'landing' ? 'md:pl-[272px]' : ''}`}
      >
        {currentView !== 'landing' && <Header onOpenAiAssistant={() => setIsAiAssistantOpen(true)} setView={setCurrentView} />}
