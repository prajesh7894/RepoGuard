...
void main() {
    ...
    vec3 base = mix(color1, color2, uv.y + noise * 0.1);
    
    float pulse = smoothstep(0.4, 0.0, length(uv - vec2(0.5 + sin(u_time * 0.5) * 0.2, 0.5)));
    vec3 finalColor = mix(base, accent * 0.2, pulse * 0.3);
